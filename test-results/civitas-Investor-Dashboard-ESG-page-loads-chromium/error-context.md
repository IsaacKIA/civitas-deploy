...
- Name: civitas.spec.ts >> Investor Dashboard >> ESG page loads
- Location: tests\civitas.spec.ts:184:7
...
Call log:
  - navigating to "http://localhost:3000/dashboard/investor/esg", waiting until "domcontentloaded"
