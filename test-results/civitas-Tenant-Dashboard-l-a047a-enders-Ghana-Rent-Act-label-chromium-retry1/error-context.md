...
- Name: civitas.spec.ts >> Tenant Dashboard >> lease page renders Ghana Rent Act label
- Location: tests\civitas.spec.ts:163:7
...
Call log:
  - navigating to "http://localhost:3000/dashboard/tenant/lease", waiting until "domcontentloaded"
