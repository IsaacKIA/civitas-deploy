...
- Name: civitas.spec.ts >> Owner Dashboard >> property onboarding wizard step 1 renders
- Location: tests\civitas.spec.ts:142:7
...
Call log:
  - navigating to "http://localhost:3000/dashboard/owner/properties/new", waiting until "domcontentloaded"
