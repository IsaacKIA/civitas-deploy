...
- Name: civitas.spec.ts >> Investor Dashboard >> dividends page loads
- Location: tests\civitas.spec.ts:189:7
...
Call log:
  - navigating to "http://localhost:3000/dashboard/investor/dividends", waiting until "domcontentloaded"
