...
- Name: civitas.spec.ts >> Portal Authentication >> sign-in form renders email and password fields
- Location: tests\civitas.spec.ts:91:7
...
- paragraph: An unexpected error occurred. Our engineering team has been automatically notified.
- code: "Error Ref: 193477067"
- button "Try Again"
- link "← Back to Homepage":
  - /url: /
- text: Need help?
- link "admin@civitasestate.com":
  - /url: mailto:admin@civitasestate.com
```
