    ...
    <div className="bg-white/5 border border-white/10 backdrop-blur-xl rounded-3xl p-8 text-white max-w-xl w-full shadow-2xl">
      <div className="mb-6">
        ...
        <p className="text-xs text-white/60">
          Illustrative estimate of monthly utility savings from going solar — not a quote or installation service.
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        <div className="bg-[#0F3D26]/60 border border-[#2E8B6A]/30 rounded-2xl p-4">
          ...
          <div className="text-[10px] text-white/60 mt-1">Per month (assumes ~85% grid offset)</div>
        </div>
