...
- Name: civitas.spec.ts >> Owner Dashboard >> maintenance wizard step 1 renders 8 category tiles
- Location: tests\civitas.spec.ts:135:7
...
Call log:
  - navigating to "http://localhost:3000/dashboard/owner/maintenance", waiting until "domcontentloaded"
