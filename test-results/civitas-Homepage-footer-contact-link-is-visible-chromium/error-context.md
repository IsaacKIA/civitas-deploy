...
- Name: civitas.spec.ts >> Homepage >> footer contact link is visible
- Location: tests\civitas.spec.ts:30:7
...
Locator: locator('a[href="mailto:admin@civitasestate.com"]').first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('a[href="mailto:admin@civitasestate.com"]').first()
...
- dialog "Runtime Error":
  ...
  - button "Attach Node.js inspector":
    - img
  - text: Could not find the module "[project]/node_modules/next/dist/client/components/builtin/global-error.js#default" in the React Client Manifest. This is probably a bug in the React Server Components bundler.
