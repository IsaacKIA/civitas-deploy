...
export default async function SmeDocumentsPage() {
  ...
  return (
    <DashboardLayout role="sme" userName={auth.profile.full_name}>
      <DocumentsClient
        ...
        hideLeases={true}
        hasError={!!docsError}
        titleText="Commercial Facility & Compliance Vault"
        subtitleText="Commercial leases, fire safety certificates, EPA permits, SLA service contracts, and VAT receipts"
        accentColor="#1E40AF"
      />
    </DashboardLayout>
  );
